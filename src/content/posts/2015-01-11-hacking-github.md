...
description: Fourteen simple apps to introduce open source to the uninitiated, lower the barrier to entry for atypical GitHub users, and show the power of adding smart tools to a simple platform.
---
