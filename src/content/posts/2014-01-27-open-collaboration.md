...
description: Open source has always been about the right to modify, not contribute. As those workflows spread beyond software, we may need a new word.
tldr: "Open source has always been about the right to modify, not the right to contribute. As those workflows spread beyond software, we may need a new word for what we're really doing."
---
