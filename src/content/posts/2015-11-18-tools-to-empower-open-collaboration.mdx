...
description: Open-source-inspired collaboration tools are open, linkable, asynchronous, and naturally capture and expose process. Are you working the way you'd like, or just the way everyone else does?
---
