...
description: "You can't be a closed-source culture behind the firewall and expect to foster an open source community publicly. Five best practices for getting your internal collaboration right first."
---
