...
description: Asynchronous communication through issues and chat eliminates the "you had to be there" aspect of corporate workflows and reduces the need to shuttle information between teams.
