...
description: A step-by-step guide to converting ESRI Shapefiles to GeoJSON format for rendering as interactive maps on GitHub, plus why open formats matter for public data.
---
