...
description: Default to transferring context asynchronously. If you receive a meeting invite without context, an agenda, or a read-ahead doc, consider politely declining.
---
