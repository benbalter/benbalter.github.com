...
description: Use pull request bodies to document the proposed change, especially the why, and cross link related issues or PRs to create a trail of breadcrumbs for future contributors.
---
