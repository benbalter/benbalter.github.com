...
description: Add an edit button to your GitHub Pages site and invite readers to collaborate on your content — it's just one predictable URL.
tldr: "If you host your site on GitHub or GitHub Pages, an edit button (and thus encouraging collaboration around your content) is simply a matter of linking to an easily predictable URL."
---
