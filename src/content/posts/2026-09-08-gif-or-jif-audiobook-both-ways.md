---
title: "It's pronounced JIF. The Open and Async audiobook is out."
description: "The Open and Async audiobook is out. It's read by a synthetic narrator who says 'jif,' correctly. For the hard-G crowd who insist that's heresy, I re-recorded an entire chapter in their (wrong) pronunciation and posted it free. One chapter the wrong way, or eleven and a half hours the right way."
tldr: "The Open and Async audiobook is out, and the narrator says 'jif,' correctly. Since the internet will never drop the hard-G thing, I recorded a chapter both ways and posted them free. You get one chapter the wrong way, or eleven and a half hours the right way."
published: true
bookCtaVariant: featured
---

The *[Open and Async](https://open-and-async.com/?utm_source=benbalter-gif-jif-post)* audiobook is out. It's read by a synthetic voice, which means that at some point a machine had to decide how to say GIF, with no help from me. It picked "jif." Correctly. I have never been prouder of a robot.
...
For the record: soft G. It's "jif," like the peanut butter.[^wilhite] Reasonable, thoughtful, wrong people say it with a hard G. We work together anyway.
...
:quote[Synthetic is the shortcut, and I'm not going to pretend it's anything else.]{#synthetic-shortcut}
...
[^qa]: The audiobook has its own QA suite. It transcribes the generated narration back to text, diffs that against the script, and flags mispronunciations, so a stray hard-G "gif" can't slip into the correct edition. The machine reads. I still get the last ear.
