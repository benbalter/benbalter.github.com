...
- [Write-good](https://github.com/btford/write-good): weak prose, like passive voice, weasel words, and clichés
...
- **semantic**: the one the other two can't do, the same *point* restated in different words. An on-demand LLM audit, designed so it never feeds the whole book to a model, runs three passes, each over small units:
