...
- [LanguageTool](https://languagetool.org/) — grammar, punctuation, and style; self-hosted, so it ran on-device too (well, in the Codespace)
...
…plus a couple dozen more for smallcaps, em-dashes, doubled words, en-dash ranges, TL;DR length, and every other tic I could name.[^validators]
