...
Then it clicked. I've been making websites for decades—so what if I made a book the same way, instead of starting in a word processor and doing a magic-trick reveal at the end? The same tools that build websites could build books. There were a few missteps along the way (I do *not*, for example, recommend trying to learn LaTeX for typesetting), but in the end, I would not have written [Open and Async](https://open-and-async.com) any other way. If you've read how I [over-engineered my home network](/2020/12/04/over-engineered-home-network-for-privacy-and-security/) — [twice](/2021/09/01/how-i-re-over-engineered-my-home-network/) — none of this will surprise you.
