...
[^latex]: Chief among them: I lost a weekend to LaTeX, on the theory that the tool serious typesetters swear by had to be worth learning. It is — if you typeset for a living. For me it was a wall of arcane macros and inscrutable errors to approximate a layout CSS gave me in an afternoon. I bailed and never looked back, which is how the whole book ended up drawn with a web box model instead.
