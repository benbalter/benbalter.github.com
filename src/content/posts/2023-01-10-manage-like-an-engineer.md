...
Managing like an engineer means a manager's go-to tools for planning, tracking, and communicating managerial work are issues, project boards, Markdown files, and pull requests:[^8]
