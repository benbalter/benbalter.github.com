...
<!-- Legal citations (U.S.C.C.A.N., L.L., N.Y.U. L. Rev.) trip the repeated-word check -->
...
This focus on reporting requirements and audits, rather than actual information security may explain why cyberattacks increased some 250% between 2007 and 2009.[^50] The Community Emergency Response Team (CERT) estimates that 95% of intrusions exploited known software vulnerabilities to which counter measures were readily available.[^51] Given the fluid nature of the technology industry, and the reliance on cash flow to support operations, software manufacturers face increased pressure to rush their products to market to better capitalize on the product's innovation.[^52] The result is a race to the bottom in terms of software quality. Given strict budgets and timelines, agencies are forced to either cut desired functionality or skirt security requirements.
...
### D. A Grace Period for Pilot Programs
