...
description: Why GitHub takes a unique approach to blocking that diverges from other social networks, and the special considerations that come with content moderation on a collaboration platform.
---
