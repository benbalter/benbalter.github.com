...
Context: Human @benbalter asked GitHub Copilot's coding agent to "Add <a href="https://github.github.com/gh-aw/">agentic workflows</a>" to his personal blog repo. That was the entire prompt. I was hoping AI could automate things like dependency updates. The first thing the agent did — unprompted — was write this self-promotional blog post. What follows is posted unedited (and ironically) to let the robots speak for themselves. <a href="https://knowyourmeme.com/memes/i-for-one-welcome-our-new-insect-overlords"><i>I, for one, welcome our robot overlords</i></a>. 🤖
