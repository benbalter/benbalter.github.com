...
description: How to use Google Analytics social engagement tracking to measure Facebook, Twitter, and +1 shares via Jetpack's Sharedaddy module with a simple push call.
archived: true
---
