...
description: Word Diff automatically converts Word documents to Markdown on each commit to GitHub, where they can be diffed, versioned, and collaborated on internally.
---
