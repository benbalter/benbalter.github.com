...
description: "Word Diff automatically converts Word documents to Markdown each time you commit to GitHub, so they can be diffed, versioned, and collaborated on like code."
---
