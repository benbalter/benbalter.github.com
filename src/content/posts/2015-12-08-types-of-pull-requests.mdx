...
description: Not all pull requests are equal. Six distinct strategies for using pull requests on GitHub, from quick heads-ups to deep reviews.
tldr: "Not all pull requests are created equal. From quick heads-ups to line-by-line reviews, here are six distinct strategies for using pull requests to collaborate on GitHub."
...
**When to use it:** When you've got a small change, potentially in a part of the codebase outside your area of expertise, and you'd like someone with more experience to provide a quick :+1: before you merge the change.
