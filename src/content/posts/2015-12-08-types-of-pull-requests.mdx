...
description: Not all pull requests are created equal. From quick heads-ups to line-by-line reviews, here are six distinct strategies for using pull requests to collaborate on GitHub.
