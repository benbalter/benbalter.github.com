...
description: Six different strategies for using pull requests on GitHub, from heads-up notifications and sanity checks to work-in-progress drafts and line-by-line reviews.
