...
description: Call it taste, culture, or zen — every organization has shared assumptions that guide decisions and resolve ambiguity in pursuit of its mission.
tldr: "Whether you call it taste, culture, or zen, there are underlying assumptions that members of an organization rely on to resolve ambiguity in pursuit of the organization's mission."
---
...
<div class="grid lg:grid-cols-[auto_1fr] gap-4 items-center">
<div class="min-w-0">
...
<div class="min-w-0">
  <pre data-zen hidden role="img" aria-label="ASCII-art Octocat reciting a random line of GitHub Zen" style="font-size: 8px; line-height: 1.2;"></pre>
</div>
</div>

These aren't mere words. There's [an API endpoint to retrieve random Zen](https://api.github.com/zen) (as seen live above), should you ever need it. Whether you've written them down or not, whether you've discussed them or not, whether you've realized them or not, every decision members of your organization make is bound by the constraints of these (often unspoken) [first principles](https://en.wikipedia.org/wiki/First_principle).
