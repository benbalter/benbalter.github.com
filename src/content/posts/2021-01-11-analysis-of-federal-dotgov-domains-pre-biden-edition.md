...
description: A data-driven snapshot of 1,121 federal .gov domains ahead of the Biden administration, covering HTTPS adoption, CMS usage, open source, and more.
---
...
You can [browse the full results, download the raw data, or see details for an individual domain within the report itself](https://github.com/benbalter/2021-analysis-of-federal-dotgov-domains), but here are the highlights:
...
- **IPv6** - 669 (72.25%) domains returned an AAAA record, indicating they supported [IPv6](https://en.wikipedia.org/wiki/IPv6) traffic. That represents about 50 fewer than 2015, but a 20% increase overall.
...
- **Host** - It’s not always possible to detect the hosting provider, but at least 109 (11.77%) live domains use AWS (up from just 10 in 2011), 5 (0.54%) use Azure, and 1 (0.11%) uses GitHub Pages.
