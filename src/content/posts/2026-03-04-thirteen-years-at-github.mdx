...
Context: today marks thirteen years since I joined GitHub. I've been writing a book—_Open and Async_—distilling everything I've learned about remote and distributed work into a playbook. To mark the "Hubberversary," what follows is a <abbr class="initialism" data-tooltip="true" data-tooltip-text="Work in progress" role="button" aria-expanded="false" tabindex="0">WIP</abbr> sneak preview of the book's intro:
