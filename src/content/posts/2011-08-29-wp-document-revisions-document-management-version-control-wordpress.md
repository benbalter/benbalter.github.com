...
description: WP Document Revisions is an open-source document management and version control plugin for WordPress. Think of it as a more intuitive alternative to SharePoint.
