...
Whether you're a manager or an individual contributor (IC), know which style you default to—and which your manager defaults to. Your team might be a mix, or the right approach might shift depending on the scenario. That's fine. The two styles typically differ in a few concrete ways:
