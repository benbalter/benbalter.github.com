...
comments: true
description: The government's FedRAMP requirements, intended to make it easier for agencies to adopt the cloud, actually make it significantly harder for them to keep pace with the private sector.
---
