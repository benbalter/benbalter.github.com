...
It's often said that government IT is five to ten years behind that of the private sector. It doesn't need to be that way. It's possible to fold the map in half and bring the East coast a bit closer to the West coast. :quote[It starts not with what we work on, but in how we work.]{#not-what-but-how-we-work}
