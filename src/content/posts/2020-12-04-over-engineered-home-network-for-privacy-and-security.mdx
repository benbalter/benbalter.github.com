...
While most home networking setups generally do a decent job of protect you from threats from the outside trying to come in, :quote[they don't often do a great job of managing risks originating from within your own network]{#risks-from-within}. Specifically, I had a number of goals:
