...
description: How I used a UniFi Dream Machine, VLANs, Pi-Hole, DNS over HTTPS, and Cloudflare Gateway to over-engineer my home network for privacy and security.
---
