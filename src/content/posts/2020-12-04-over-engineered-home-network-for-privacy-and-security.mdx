...
description: How I used a UniFi Dream Machine, VLANs, Pi-Hole, cloudflared, and Cloudflare Gateway to over-optimize my home network for privacy, security, and ad blocking.
---
