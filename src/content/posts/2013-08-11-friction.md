---
title: Friction
description: The only metric that truly matters for an open source project is friction — the time between wanting to contribute and actually contributing. Minimize it and your community will grow.
---
