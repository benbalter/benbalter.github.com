---
title: Friction
description: Friction — the time between wanting to contribute and actually contributing — is the only metric that matters for open source.
tldr: "The only metric that truly matters for an open source project is friction — the time between wanting to contribute and actually contributing. Minimize it and your community will grow."
---
