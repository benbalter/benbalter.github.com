...
description: Slides and recording from a lightning talk at the WordPress DC Meetup on the basics of HTML and PHP, helping non-developers avoid breaking their websites when making edits.
archived: true
---
...
- The process
  ...
  - The server executes PHP and outputs HTML, CSS, JavaScript, and so on<img src="https://ben.balter.com/wp-content/uploads/2011/04/infographic-300x138.png" alt="Screenshot of the presentation showing the relationship between server, browser, and user" title="infographic" class="float-end ms-3" />
