...
description: Seven habits of developers who consistently ship great features, including over-communicating, writing features before code, getting products to users early, and optimizing for user outcomes.
---
