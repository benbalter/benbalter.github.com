...
export const aboutContent = `I'm Ben Balter — I write here about engineering leadership, open source, and showing your work. I wrote [Open & Async](https://open-and-async.com/), the playbook for remote and distributed teams. My open source projects have hundreds of millions of downloads. I was the Director of Hubber Enablement at [GitHub](https://github.com/about), where I helped thousands of GitHubbers do their best remote work. Before this role: Chief of Staff for Security, enterprise PM, and GitHub's first Government Evangelist. Before GitHub: attorney, Presidential Innovation Fellow, and member of the White House's first agile development team.
