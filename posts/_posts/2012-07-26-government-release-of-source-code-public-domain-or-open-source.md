...
[^1]: I'd argue that all software, even government funded software should still be licensed under a traditional open source license, to resolve any legal ambiguity when used abroad under the terms of various international copyright treaties and agreements [14]
[^2]: Although citizen-contributions to that project would theoretically not be public domain, thus necessitating a license, which should be clarified in the project's documentation at the time of release to avoid potential issues with 21 U.S.C. § 1342. [15]
[^3]: Although again, technically speaking the project as a whole would be licensed under GPL,  individual code not dependent on the parent project could be used as a US Government Work. [16]
[^4]: Unless you're looking at the [vibrant open source cold fusion community][17]. [18]
[^5]: FAR 52.227-14(c)(1)(i). Even if the contracting officer grants such rights, they do not take effect unless the contractor includes a copyright notice at the time of delivery, acknowledging the government's sponsorship and indicating the contract number under which it was procured. See FAR 27.404(a)(5). [19]
[^6]: General counsels across government already have enough ammunition to stymy progress. [20]
[^7]: Often the last and least seen step in the enterprise development process [21]
[^8]: There's been [exactly one pull request to date][22] across all government github repos [23]
 ...
 [4]: #note-2020-1 "I'd argue that all software, even government funded software should still be licensed under a traditional open source license, to resolve any legal ambiguity when used abroad under the terms of various international copyright treaties and agreements"
 [5]: #note-2020-2 "Although citizen-contributions to that project would theoretically not be public domain, thus necessitating a license, which should be clarified in the project's documentation at the time of release to avoid potential issues with 21 U.S.C. § 1342."
 [6]: #note-2020-3 "Although again, technically speaking the project as a whole would be licensed under GPL,  individual code not dependent on the parent project could be used as a US Government Work."
 [7]: #note-2020-4 "Unless you're looking at the vibrant open source cold fusion community."
 [8]: #note-2020-5 "FAR 52.227-14(c)(1)(i). Even if the contracting officer grants such rights, they do not take effect unless the contractor includes a copyright notice at the time of delivery, acknowledging the government's sponsorship and indicating the contract number under which it was procured. See FAR 27.404(a)(5)."
 [9]: https://twitter.com/anildash/statuses/227476701599391744
 [10]: #note-2020-6 "General counsels across government already have enough ammunition to stymy progress."
 [11]: #note-2020-7 "Often the last and least seen step in the enterprise development process"
 [12]: #note-2020-8 "There's been exactly one pull request to date across all government github repos"
