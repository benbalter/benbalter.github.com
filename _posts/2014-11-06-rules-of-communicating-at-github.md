...
2. **[`Feedbac`](https://github.com/benbalter/benbalter.github.com/commit/Feedbac)k** - Hey, I think you could have worded that comment better. Is everything going okay with Y? Feedback is inherently human, and as such, it deserves a human face.
...
1. **It’s not the obnoxious bump** - Be sincere, explicit, and charming. "[**@benbalter**](https://github.com/benbalter), the gentlest of bumps on this. Have two minute to take a look at this error? :smile:". Your goal is to make sure that they are aware of the ask, not to trample their right to manage their own time.
