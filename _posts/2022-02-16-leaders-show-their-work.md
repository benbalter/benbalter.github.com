...
Absent working within systems that organically capture and expose process, transparency takes work. Leaders should hold one another accountable for spending the additional cycles to show their work. So how do you do that?

### How to ensure you are showing your work

The easiest way to show your work is to quite literally [prefer asynchronous communication](https://ben.balter.com/2014/11/06/rules-of-communicating-at-github/#1-prefer-asynchronous-communication) over real-time or just-in-time formats, even when it feels like doing so incurs an immediate cost. It's a matter of optimizing your communication for the recipient, instead of for the sender.

There's a lot you get for "free" from such tools, but async is not always going to be the best option for every situation. While you should never "roll your own" crypto, if you're looking to "roll your own" transparency through showing your work after the fact, here are some tips to keep in mind:
