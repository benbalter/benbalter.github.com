...
* **Captures institutional knowledge** - When you're purposeful about where and how you share context, you alleviate the need for “you had to be there” and “go ask Susan"-type inquiries. This allows others to continue the work when circumstances evolve, not to mention, process artifacts also naturally capture what other alternatives were considered, allowing those who follow to more easily stand on the shoulders of those before them.
