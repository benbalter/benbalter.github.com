...
But what about the rest of the internet? The part not purpose-build for government? The services that meet industry standards that predate this one arbitrary government standard? You know, the things consumers use on a daily basis and ask "why can't government just use X"? The part we want government to be able to more easily use?
