...
GitHub Pages is far from perfect, but I've learned a lot, spending three years hacking on a single product (an eternity in tech. years), and even more, hacking on open source projects, and government projects before that. These are the lessons I've learned, from what's worked, and more importantly, from what hasn't, that has informed my product philosophy today, but I'm sure there's much, much more.
