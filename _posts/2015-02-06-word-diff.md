...
You'll notice that for each change I made to `important-file.docx`, Word Diff made that same change to `important-file.md`, crediting me as the author, and preserving my original commit message, as it transparently updated the Markdown version each time I made a change. That way Git functions you're used to — like blame and a file's commit history — work just as you'd expect.
