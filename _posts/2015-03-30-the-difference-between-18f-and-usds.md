...
18F and USDS have divergent goals (getting on the front page, versus not getting on the front page), but there's more than that. I'd break the difference down into three key value statements implicit in each team's culture:
