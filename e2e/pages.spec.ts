  ...
  pages.forEach(({ url, name }) => {
    test.describe(name, () => {
      ...
      test('should have meaningful content', async ({ page }) => {
        // Use .first() to avoid strict mode violation when both main and article exist
...
test.describe('About Page', () => {
  ...
  test('should have social links', async ({ page }) => {
    // Check for Bluesky, GitHub, or LinkedIn links (Twitter is no longer used)
    const socialLinks = page.locator('a[href*="bluesky"], a[href*="github"], a[href*="linkedin"]');
