...
description: I use web notifications for everything but `@mentions`, which I have
  pushed to me via email. I subscribe to lots of repositories to ensure I don't miss
  anything, but unsubscribe from any thread not immediately relevant to me to keep
