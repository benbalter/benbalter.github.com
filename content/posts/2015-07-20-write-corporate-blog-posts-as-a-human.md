...
description: Blog posts are a great way to tell users about ships, but it's all too
  easy to fall back on the marketing speak we're inundated with each day. Instead,
  use these tips to write user-centric posts for your corporate blog.
date: '2015-07-20'
---
