...
description: How to implement `404 - not found` pages for Jekyll and GitHub pages
  that automatically suggest similar URLs to the one requested based on your site's
  `sitemap.xml`.
date: '2022-06-30'
---
