---
title: Why FedRAMP actually makes it harder for government agencies to move to the
  cloud
description: The government's new FedRAMP requirements — intended to make it easier
  for federal agencies to make the jump to the cloud — actually make it significantly
  harder for agencies to keep pace with the private sector.
date: '2014-07-29'
comments: true
---
