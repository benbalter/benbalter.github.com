...
description: What we've been calling open source, may in fact be something else, especially
  when we start to use those workflows to collaborate on things beyond code.
date: '2014-01-27'
_legacy_redirect_from: "/2014/01/27/open-collabortion/"
comments: true
---
