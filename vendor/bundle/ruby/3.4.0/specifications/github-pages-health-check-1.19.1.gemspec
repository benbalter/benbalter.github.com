# -*- encoding: utf-8 -*-
# stub: github-pages-health-check 1.19.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<addressable>.freeze, ["~> 2.8.7".freeze])
  s.add_runtime_dependency(%q<dnsruby>.freeze, ["~> 1.60".freeze])
  s.add_runtime_dependency(%q<octokit>.freeze, [">= 4".freeze, "< 10".freeze])
  s.add_runtime_dependency(%q<public_suffix>.freeze, [">= 3.0".freeze, "< 7.0".freeze])
