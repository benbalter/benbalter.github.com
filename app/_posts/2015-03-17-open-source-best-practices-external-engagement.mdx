...
<Callout>
  This post is part of a series on best practices in open source.<br />
  You may also be interested in [Five best practices in open source: internal collaboration](/2015/03/08/open-source-best-practices-internal-collaboration/).
</Callout>
